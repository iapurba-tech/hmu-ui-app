...
const UnitSelectionModal: React.FC<UnitSelectionModalProps> = ({
  ...
  const { user, activeUnit, setActiveUnit, setPortal } = useAuthStore();
  ...
  const globalAdmin = {
    ...
    activeUnits: user?.units.length || 0, // Mocked for now
                ...
                <Box sx={{ ml: 2.5, flex: 1 }}>
                  ...
                  >
                    <Box>
                      ...
                      >
                        {isGlobal
                          ? (item as any).totalUnits
                          : (item as any).mpcsUnits}
                      </Typography>
                    </Box>
                    <Box>
                      <Typography
                      ...
                      >
                        {isGlobal
                          ? (item as any).activeUnits
                          : (item as any).dailyVolume}
                      </Typography>
                    </Box>
                    {isGlobal && (
                      <Box>
