...
export const switchButtonStyle: SxProps<Theme> = {
  borderRadius: 2,
  px: 2,
  py: 1,
  bgcolor: '#1e293b', // Dark Slate 800 - Appropriate dark color for the blue theme
  color: 'white',
  display: 'flex',
  alignItems: 'center',
  gap: 1,
  ...
  '&:hover': {
    bgcolor: '#0f172a', // Dark Slate 900 on hover
